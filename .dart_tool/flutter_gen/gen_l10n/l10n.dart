...
abstract class L10n {
  ...
  /// No description provided for @savedEmotePack.
  ///
  /// In en, this message translates to:
...
class _L10nDelegate extends LocalizationsDelegate<L10n> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'bn', 'bo', 'ca', 'cs', 'de', 'el', 'en', 'eo', 'es', 'et', 'eu', 'fa', 'fi', 'fr', 'ga', 'gl', 'he', 'hi', 'hr', 'hu', 'id', 'ie', 'it', 'ja', 'ko', 'lt', 'nb', 'nl', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sr', 'sv', 'ta', 'th', 'tr', 'uk', 'vi', 'zh'].contains(locale.languageCode);
